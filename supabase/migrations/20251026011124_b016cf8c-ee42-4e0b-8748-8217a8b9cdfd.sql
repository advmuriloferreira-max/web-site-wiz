...
-- Dívidas incluídas na análise de superendividamento
...
-- PASSO 6: MIGRAÇÃO DE DADOS EXISTENTES (SE HOUVER)
-- ====================================================================

-- Migrar clientes_juros para clientes unificados
...
-- Migrar clientes_superendividamento para clientes unificados (sem email pois não existe na tabela)
INSERT INTO public.clientes (escritorio_id, nome, cpf_cnpj, observacoes, created_at)
SELECT escritorio_id, nome, cpf, observacoes, created_at
...
-- Migrar clientes_provisao para clientes unificados
