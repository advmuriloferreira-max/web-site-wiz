...
-- =====================================================
-- PASSO 1: LIMPAR ESTRUTURA ANTIGA
-- =====================================================
...
-- =====================================================
-- PASSO 2: CRIAR TABELA DE BANCOS
-- =====================================================
...
-- =====================================================
-- PASSO 3: CRIAR TABELA DE TIPOS DE GARANTIA
-- =====================================================
...
-- =====================================================
-- PASSO 4: CRIAR TABELA ANEXO I (22 FAIXAS)
-- =====================================================
...
-- =====================================================
-- PASSO 5: CRIAR TABELA ANEXO II (4 FAIXAS)
-- =====================================================
...
-- =====================================================
-- PASSO 6: CRIAR TABELA DE ANÁLISES
-- =====================================================
...
-- Bancos: Leitura pública
CREATE POLICY "Leitura pública bancos"
  ON public.bancos_brasil
  FOR SELECT
  TO authenticated
  USING (true);

-- Tipos de operação: Leitura pública
CREATE POLICY "Leitura pública tipos operação"
  ON public.tipos_operacao_carteira
  FOR SELECT
  TO authenticated
  USING (true);
...
-- Análises: Usuário vê apenas as suas
CREATE POLICY "Usuário vê suas análises"
  ON public.analises_gestao_passivo
  FOR SELECT
  TO authenticated
  USING (auth.uid() = usuario_id);

CREATE POLICY "Usuário cria suas análises"
  ON public.analises_gestao_passivo
  FOR INSERT
  TO authenticated
...
-- =====================================================
-- PASSO 10: COMENTÁRIOS PARA DOCUMENTAÇÃO
-- =====================================================
